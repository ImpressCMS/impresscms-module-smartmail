<?php
// $Id: previewmailer.php 1026 2008-04-14 15:27:26Z marcan $           //
//  ------------------------------------------------------------------------ //
...
class NewsletterPreviewMailer extends NewsletterMailer {
    ...
    /**
     * Send newsletter preview to one email address
     *
     * @param string $email
     * @return bool
     */
    ...
    /**
     * Replace {UNAME} with $xoopsUser's username, {EMAIL} with $xoopsUser's email etc. in the body and subject
     *
     */
