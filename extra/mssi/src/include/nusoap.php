...
/*
$Id: nusoap.php 1026 2008-04-14 15:27:26Z marcan $
...
// necessary classes
require_once('class.soapclient_base.php');
...
* @version  $Id: nusoap.php 1026 2008-04-14 15:27:26Z marcan $
* @access   public
*/
class nusoap_base {
	/**
...
//		}
		...
		if (
			...
			$this->setError("Unsupported HTTP response status $http_status $http_reason (soapclient_base->response has contents of the response)");
			return false;
		}
...
/**
*
* soapclient_base higher level class for easy usage.
*
* usage:
*
* // instantiate client with server info
* $soapclient_base = new soapclient_base( string path [ ,boolean wsdl] );
*
* // call method, get results
* echo $soapclient_base->call( string methodname [ ,array parameters] );
*
* // bye bye client
* unset($soapclient_base);
*
* @author   Dietrich Ayala <dietrich@ganx4.com>
* @version  $Id: nusoap.php 1026 2008-04-14 15:27:26Z marcan $
* @access   public
*/
class soapclient_base extends nusoap_base  {
	...
	* @access   public
	*/
	function soapclient_base($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
		parent::nusoap_base();
	...
	*/
	...
	";
		...
		$evalStr = 'class soap_proxy_'.$r.' extends soapclient_base {
	'.$evalStr.'
}';
		return $evalStr;
	}
